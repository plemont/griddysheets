...
// Lint JavaScript
gulp.task('lint', () =>
  gulp.src(['app/scripts/**/*.js', '!app/scripts/**/dialog-polyfill.js'])
    .pipe($.eslint(lintArgs))
    .pipe($.eslint.format())
...
gulp.task('serve', ['copy-dialog-polyfill', 'scripts', 'styles'], () => {
  browserSync({
    notify: false,
...
gulp.task('copy-dialog-polyfill', () => {
  gulp.src(['node_modules/dialog-polyfill/dialog-polyfill.js'])
